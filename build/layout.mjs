...
const sozialZeichen = {
  facebook: {
    ...
    inhalt: `<path fill-rule="evenodd" d="M12 2.1a9.9 9.9 0 1 0 0 19.8 9.9 9.9 0 0 0 0-19.8zm1.06 10.22v6.87a9.9 9.9 0 0 1-2.5 0v-6.87h-2.09v-2.6h2.09v-1.78c0-2.06 1.24-3.2 3.13-3.2.9 0 1.84.16 1.84.16v2.02h-1.04c-1.02 0-1.34.64-1.34 1.29v1.51h2.28l-.36 2.6h-1.92z"/>`
  },
  instagram: {
...
export function page({ slug, title, description, active = "", body, bodyClass = "" }) {
  ...
  return `<!DOCTYPE html>
<html lang="de" class="no-js" data-theme="dark">
<head>
<meta charset="utf-8">
...
${navMarkup(active, slug + ".html")}
    ...
    <div class="header__cta">
      ...
      <a class="kreis-knopf kreis-knopf--whatsapp" href="https://wa.me/${company.whatsappHref}"
         target="_blank" rel="noopener" aria-label="Uns per WhatsApp schreiben">
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M12.04 2.02c-5.46 0-9.9 4.44-9.9 9.9 0 1.74.46 3.45 1.33 4.95L2 22.02l5.25-1.37a9.86 9.86 0 0 0 4.78 1.22h.01c5.46 0 9.9-4.44 9.9-9.9a9.84 9.84 0 0 0-2.9-7 9.84 9.84 0 0 0-7-2.95zm0 18.13h-.01c-1.52 0-3.01-.41-4.31-1.18l-.31-.18-3.2.84.85-3.12-.2-.32a8.2 8.2 0 0 1-1.26-4.38c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.42a8.18 8.18 0 0 1 2.41 5.82c0 4.54-3.7 8.23-8.03 8.33zm4.52-6.16c-.25-.12-1.47-.72-1.69-.81-.23-.08-.39-.12-.56.13-.16.25-.64.81-.79.98-.14.16-.29.18-.54.06-.25-.13-1.05-.39-1.99-1.23-.74-.66-1.23-1.47-1.38-1.72-.14-.25-.02-.38.11-.51.11-.11.25-.29.37-.43.13-.15.17-.25.25-.41.08-.17.04-.31-.02-.43-.06-.12-.56-1.34-.76-1.84-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.43.06-.66.31-.23.25-.86.85-.86 2.07s.89 2.4 1.01 2.56c.12.17 1.75 2.67 4.23 3.74.59.26 1.05.41 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.47-.6 1.67-1.18.21-.58.21-1.08.15-1.18-.06-.11-.23-.17-.48-.29z"/>
        </svg>
      </a>
